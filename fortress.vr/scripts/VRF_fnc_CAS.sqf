...
if (_activated) then {
	...
	waitUntil {!isNil {_logic getvariable "vehicle"} && !isNil {_logic getvariable "type"}};
	...
	_dirVar = "VRF_fnc_CAS" + typeof _logic;
	...
	////////////////////////////////////////////////
	// To count CAS kills as kills made by player //
	////////////////////////////////////////////////
	_plane setVariable ["FS_CASowner", profileNameSpace getVariable "VRFORTRESS_PlayerID", TRUE];
